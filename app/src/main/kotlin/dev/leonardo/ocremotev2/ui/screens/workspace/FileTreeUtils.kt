 ...
 *
 * Only descends into directories whose [dev.leonardo.ocremotev2.domain.model.FileNode.path] is in [expandedDirs].
 ...
 * @param showIgnored if false, nodes with [dev.leonardo.ocremotev2.domain.model.FileNode.ignored] = true are skipped
 ...
 *
 * @param path     the [dev.leonardo.ocremotev2.domain.model.FileNode.path] of the target directory node
