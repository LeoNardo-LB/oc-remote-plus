...
import dev.leonardo.ocremotev2.ui.navigation.NavGraph
...
class MainActivity : ComponentActivity() {
    ...
    override fun attachBaseContext(newBase: Context) {
        ...
        val languageCode = dev.leonardo.ocremotev2.data.repository.SettingsDataStore.getStoredLanguage(newBase)
