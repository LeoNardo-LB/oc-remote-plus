package dev.leonardo.ocremoteplus.service
...
import dev.leonardo.ocremoteplus.data.api.NetworkMonitor
import dev.leonardo.ocremoteplus.data.api.NetworkState
...
import dev.leonardo.ocremoteplus.domain.repository.SettingsRepository as DomainSettingsRepository
...
class OpenCodeConnectionService : Service() {
    ...
    companion object {
        const val ACTION_OPEN_SESSION = "dev.leonardo.ocremoteplus.OPEN_SESSION"
        const val ACTION_DISCONNECT = "dev.leonardo.ocremoteplus.DISCONNECT"
        const val ACTION_DISCONNECT_ALL = "dev.leonardo.ocremoteplus.DISCONNECT_ALL"
