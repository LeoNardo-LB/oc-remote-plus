...
import dev.leonardo.ocremoteplus.data.dto.common.ModelSelection as DataModelSelection
import dev.leonardo.ocremoteplus.data.dto.request.PromptPart as DataPromptPart
import dev.leonardo.ocremoteplus.data.repository.handler.CompactionStateInfo as DataCompactionStateInfo
import dev.leonardo.ocremoteplus.data.repository.handler.StepProgressInfo as DataStepProgressInfo
import dev.leonardo.ocremoteplus.data.repository.handler.ToolProgressInfo as DataToolProgressInfo
import dev.leonardo.ocremoteplus.domain.model.CompactionStateInfo
...
class ChatRepositoryImpl @Inject constructor(
    ...
    override suspend fun selectModel(serverId: String, providerId: String, modelId: String): Result<Unit> = runCatching {
        ...
        providerApi.updateConfig(conn, dev.leonardo.ocremoteplus.data.dto.request.ServerConfigPatch())
    }
    ...
    private fun dev.leonardo.ocremoteplus.data.dto.response.PermissionRequest.toDomainPermissionState() = PermissionState(
        id = id,
        sessionId = sessionId,
        permission = permission,
        patterns = patterns,
    ...
    private fun dev.leonardo.ocremoteplus.data.dto.response.QuestionRequest.toDomainQuestionState() = QuestionState(
        id = id,
        sessionId = sessionId,
        questions = questions.map { q ->
            QuestionState.Question(
    ...
    override suspend fun addPermissionAutoApproveRule(rule: dev.leonardo.ocremoteplus.domain.model.AutoApproveRule) {
